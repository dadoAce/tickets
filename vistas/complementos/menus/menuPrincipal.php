<div id="menu-lateral-1" class="menu-lateral-content  text-center h-100 float-left pl-2 pr-2">
    <div class="h-100  d-flex flex-column justify-content-star align-items-center  ">
        ...
        <div class="menu-seccion text-left pl-4">
            <div class="menu-seccion-item text-left pl-2">
                <a href="<?= $this->base_url("Admin") ?>">Dashboard</a>
            </div>
            <div class="menu-seccion-item text-left pl-2">
                <a href="<?= $this->base_url("Admin/Settings") ?>">Settings</a>
            </div>
            <div class="menu-seccion-item text-left pl-2">
